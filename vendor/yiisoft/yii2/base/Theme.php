 ...
 * then the themed version for a view file `@app/views/main/index.php` will be
 * `@app/themes/basic/main/index.php`.
 *
 ...
 * ```
 *
 * In this case, the themed version could be either `@app/themes/christmas/main/index.php` or
 * `@app/themes/basic/main/index.php`. The former has precedence over the latter if both files exist.
 *
